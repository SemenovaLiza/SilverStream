...
CREATE INDEX IF NOT EXISTS film_work_creation_date_idx ON film_work(creation_date);
...
CREATE UNIQUE INDEX IF NOT EXISTS genre_film_work_idx ON genre_film_work (film_work_id, genre_id);
